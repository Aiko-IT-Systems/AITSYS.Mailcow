...
# One-click rebuild
#
# Rebuilds all AITSYS.Mailcow components with default values.
#
# Author: Emzi0767
...
$target = "..\aitsys-mailcow-artifacts"
...
$docs_path = ".\AITSYS.Mailcow.Docs"
$docs_pkgname = "aitsys-mailcow-docs"
